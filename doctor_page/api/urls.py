...
urlpatterns = [
    ...
    path('admin/patients/', views.list_doctor_patients, name='list-patients'),
    path('admin/appointments/', views.doctor_appointments, name='list-appointments'),
    path('doctor/patients/', views.doctor_patients, name='list-doctor-patients'),
    ...
    path('appointments/mark/<int:appointment_id>/consulted/', views.mark_appointment_consulted, name="mark-appointment-consulted")
]
